...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/weblaptop/public/css/gioithieu.css">
...
<body>
    <div class="gt">
        <h1><strong>GIỚI THIỆU TN STORE</strong></h1>
        <h2>THÔNG TIN GIỚI THIỆU VỀ CỬA HÀNG TN STORE</h2>
    </div>
    <div class="content">
        <div class="row">
            <div class="col-5">
                <img src="/weblaptop/public/image/anhlaptop/gioithieu.jpeg" alt="">
                <div class="haianh">
                    <img src="/weblaptop/public/image/hinhbia/banner1.jpg" alt="">
                    <img src="/weblaptop/public/image/anhlaptop/anh8.jpg" alt="">
                </div>
            </div>
            <div class="col-6 textgt">
            <p class="gioithieu5">Mặt hàng kinh doanh: máy tính bao gồm các thương hiệu như DELL, ASUS, LENOVO, MACBOOK , HP,...
                ...
                <br>TN STORE là một cửa hàng quy mô nhỏ chuyên bán các loại máy tính, nhưng lại cung cấp đầy đủ, đa dạng các loại sản phẩm. Ưu thế lơn nhất của cửa hàng là phục vụ khách hàng 24/24, đây được xem là điểm cộng có thể đáp ứng được nhu cầu khách hàng.</br>
                <br>TN STORE cam kết bán hàng chính hãng, sản phẩm vô cùng phong phú, đa dang
            </p>
            </div>
        </div>
    </div>
    ...
    <div class="row row2">
        <div class="col-md-4">
            <div class="card d-flex mx-auto">
                <div class="card-image"> <img class="img-fluid d-flex mx-auto" src="/weblaptop/public/image/anhlaptop/gioithieu2.jpeg"> </div>
                <div class="card-text">
                ...
                <div class="dm"> <span id="name">TN STORE<br></span> </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card d-flex mx-auto">
                <div class="card-image"> <img class="img-fluid d-flex mx-auto" src="/weblaptop/public/image/anhlaptop/gioithieu3.jpeg"> </div>
                <div class="card-text">
        ...
        <div class="col-md-4">
            <div class="card d-flex mx-auto ">
                <div class="card-image"> <img class="img-fluid d-flex mx-auto" src="/weblaptop/public/image/anhlaptop/gioithieu4.jpeg"> </div>
                <div class="card-text">
                    <div class="card-title">TN STORE</div> 
